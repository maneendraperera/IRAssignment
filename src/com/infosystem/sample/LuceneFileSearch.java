...
public class LuceneFileSearch {
    ...
    public LuceneFileSearch(Directory fsDirectory, Analyzer analyzer) {
        super();
    ...
    public void addFileToIndex(String filepath) throws IOException, URISyntaxException {
    	...
    	String path = "//Users//maneendraperera//Documents//OVGUWorkspace//InformationRetreivalSystem//test//file1.txt";
		...
		//List<File> fileList = fileHelper.listAllFiles();
    ...
    public List<Document> searchFiles(String inField, String queryString) {
        try {
            ...
            for (ScoreDoc scoreDoc : topDocs.scoreDocs) {
                ...
                System.out.println("outputs ****** " + scoreDoc.doc + " ***** " + scoreDoc.score);
            }
